...
from deep_models import get_params_deep, FCNN
import train_deep
...
def objective_deep(trial, model_type, train_x, train_y, model_seed, data_seed, epochs):
    """Main function for optuna optimization (deep_models)
